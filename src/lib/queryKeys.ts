...
export const itemKeys = {
  ...
  /**
   * Есть ли в каталоге хоть одна доступная вещь — вопрос БЕЗ фильтров.
   *
   * Отдельный ключ, а не поле в ответе витрины: витрина отвечает «по этим
   * фильтрам ничего», и по её ответу нельзя отличить «не нашлось здесь» от
   * «нет нигде». Разница не косметическая — от неё зависит, предлагать ли
   * расширить радиус, и правду ли говорит заголовок пустого экрана.
   *
   * Префикс ['items'] намеренный: выложили вещь — invalidateItemCaches гасит
