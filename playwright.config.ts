...
export default defineConfig({
  testDir: './tests',
  // Набор пишет в ЖИВОЕ развёртывание (стенда у проекта сейчас нет).
  // setup говорит об этом вслух до первого теста, teardown убирает за
  // прогоном САМ — раньше уборку полагалось запускать руками, и 19.09
  // стало видно, чего это стоит: единственным объявлением на витрине
  // прода была вещь, оставленная оборвавшимся прогоном.
